...
public class Students_PWModify{
   ...
   public Students_PWModify(){
      ...
      btn_ok.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
        	 d.setStudent(dio.refreshStudentdata());                        
            if(d.getStudent().get(d.getStuindex()).getStupw().equals(t_orginal.getText()))
           {           
            	if((t_orginal.getText()).equals(t_modify.getText()))
            	{
                    ...
                    dio.saveStudentData(d.getStudent());             
